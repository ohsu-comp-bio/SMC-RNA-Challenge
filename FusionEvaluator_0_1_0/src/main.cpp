...
int main(int argc, char * argv[])
{
    ...
    while(1)
    {
        c = getopt_long(argc, argv, "t:r:g:o:s:b:p:h",
    ...
    ExecuteByRule exe;
    exe.execute(res, truth, (char*)output_file.c_str(), (char*)rule_file.c_str(), evaluates, g, base_resolution, pct);

    cerr<<"printing evaluation results..."<<endl;
   
    Printer per;
    per.print(evaluates, (char*)output_file.c_str(), gene_file, base_resolution, pseudo_counts, version);
